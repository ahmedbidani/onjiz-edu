class IndexFormStudentMasterBackendEKP extends BaseBackendEKP {
  constructor() {
    super();
    this.initialize();
  }
  ...
  initialize() {
    ...
    this.form = new FormIndexStudentMasterBackendEKP(this);
  }
}

class FormIndexStudentMasterBackendEKP {
  constructor(opts) {
    _.extend(this, opts);
